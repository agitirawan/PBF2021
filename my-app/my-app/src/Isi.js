                    ...
                    <div className="row">
                        <div className="col-md-4 p-2">
                            <figure className="figure">
                                <img src="https://res.cloudinary.com/dzxa9hy4o/image/upload/v1617542460/PBF/oedsm2zp9algselululv.jpg" class="figure-img img-fluid rounded" alt="..." />
                            </figure>
                        </div>
